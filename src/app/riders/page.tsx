        ...
        <Container className="relative">
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div className="relative mx-auto w-full max-w-[300px] lg:max-w-[360px]">
              <div
                aria-hidden
                className="absolute -inset-8 -z-10 rounded-[4rem] bg-brand-orange/10 blur-3xl"
              />
              <Image
                src="/brand/screens/rider-app.png"
                alt="BiteExpress Rider app showing available deliveries and earnings"
                width={882}
                height={1783}
                priority
